...
function usp_checkForPublicSubmission() {
	...
	if (isset($_POST['user-submitted-post'], $_POST['usp-nonce']) && !empty($_POST['user-submitted-post']) && wp_verify_nonce($_POST['usp-nonce'], 'usp-nonce')) {
		...
		$author = ''; $url = ''; $email = ''; $tags = ''; $captcha = ''; $verify = ''; $content = ''; $category = ''; $order_category = ''; $order_city=''; $order_date='';
		...
		if (isset($_POST['user-order-category'])) $order_category = sanitize_text_field($_POST['user-order-category']);
		if (isset($_POST['user-order-city'])) $order_city = sanitize_text_field($_POST['user-order-city']);
		if (isset($_POST['user-order-start-day'])) $order_date = sanitize_text_field($_POST['user-order-start-day']);

		
		$result = usp_createPublicSubmission($title, $files, $ip, $author, $url, $email, $tags, $captcha, $verify, $content, $category,  $order_category, $order_city, $order_date);
...
// process submission
function usp_createPublicSubmission($title, $files, $ip, $author, $url, $email, $tags, $captcha, $verify, $content, $category, $order_category, $order_city, $order_date) {
