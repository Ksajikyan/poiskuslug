	...
	function set_predefined_fields(){
		...
		$this->predefined_fields = array(
			...
			'phone_number' => array(
				...
				'type' => 'text',
				'label' => __('Номер телефона','ultimatemember'),
				'required' => 0,
				'public' => 1,
				'editable' => 1,
			...
			'mobile_number' => array(
				...
				'type' => 'text',
				'label' => __('Мобильный номер','ultimatemember'),
				'required' => 0,
				'public' => 1,
				'editable' => 1,
				'validate' => 'phone_number',
			...
			'profile_photo' => array(
				...
				'type' => 'image',
				'label' => __('Изменить фото профиля','ultimatemember'),
				'upload_text' => __('Загрузить свою фотографию здесь,','ultimatemember'),
			...
			'cover_photo' => array(
				...
				'metakey' => 'cover_photo',
				'type' => 'image',
				'label' => __('Изменить ваше сопроводительное фото','ultimatemember'),
				'upload_text' => __('Загрузить обложку здесь','ultimatemember'),
			...
			'password_reset_text' => array(
				...
				'type' => 'block',
				'content' => '<div style="text-align:center">' . __('Чтобы сбросить пароль, введите адрес электронной почты или логин ниже','ultimatemember'). '</div>',
				'private_use' => true,
			),
			...
			'username_b' => array(
				...
				'metakey' => 'username_b',
				'type' => 'text',
				'placeholder' => __('Введите имя пользователя или по электронной почте','ultimatemember'),
				'required' => 1,
				'public' => 1,
				'editable' => 0,
				'private_use' => true,
			...
			'profile_privacy' => array(
				...
				'type' => 'select',
				'label' => __('Профиль конфиденциальности','ultimatemember'),
			...
			'hide_in_members' => array(
				...
				'type' => 'radio',
				'label' => __('Скрыть мой профиль из каталога','ultimatemember'),
			...
			'delete_account' => array(
				...
				'type' => 'radio',
				'label' => __('Удалить аккаунт','ultimatemember'),
			...
			'single_user_password' => array(
				...
				'type' => 'password',
				'label' => __('Пароль','ultimatemember'),
				'required' => 1,
				'public' => 1,
				'editable' => 1,
				'account_only' => true,
