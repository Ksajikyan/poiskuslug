...
I haven't provided screenshots but if you want help please visit my site and click on Feedback and Support.

[Zack Design](https://zackdesign.biz "Zack Design")
...
- Tested in WP 4.3.1
- Updated the Wordpress Widget implementation to use the latest PHP 5 methodology
...
= What happened to my posts? Why are things broken? =

Usually this is due to a theme or plugins conflicting with this plugin. Try disabling all plugins and using the default theme before requesting support.
...
You can do this by visiting [Zack Design](http://zackdesign.biz "Zack Design") and clicking on 'Feedback and Support' on the side.
