...
else
{
			...
			<div class="layout-span12 responsive">
				<div class="widget-layout">
					<div class="widget-layout-title">
						<h4>
							<?php _e("System Status", review_bank); ?>
						</h4>
					</div>
					<div class="widget-layout-body">
						<a class="btn btn-success system-report" href="#"><?php _e("Get System Report", review_bank); ?></a>
						<div id="wp-review-system-report" class="layout-system-report">
							<textarea readonly="readonly"></textarea>
						</div>
						<a class="btn btn-success close-report" href="#"><?php _e("Close System Report", review_bank); ?></a>
										...
										<div class="fluid-layout">
											<div class="layout-span12 responsive">
												<div class="layout-control-group">
													...
													<div class="layout-controls wp_layout_control_review_bank">
	...
	<script type="text/javascript">
		...
		jQuery("a.system-report").click(function () {
			...
			try {
				jQuery("#wp-review-system-report").slideDown();
				jQuery("#wp-review-system-report textarea").val(report).focus().select();
				jQuery(this).fadeOut();
		...
		jQuery("a.close-report").click(function () {
			jQuery("#wp-review-system-report").slideUp();
			jQuery(this).fadeOut();
